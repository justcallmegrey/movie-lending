<!--  Modal Delete -->
<div id="modal-delete" class="modal-members modal fade" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['route' => ['members.delete', encrypt($data->id)], 'method' => 'DELETE']) !!}
                    <div class="box-body">
