<!--  Modal Create -->
<div id="modal-create" class="modal-movies modal fade" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ trans('button.add')}} {{ trans('menu.movies.name') }}</h4>
